...
void Output(int index, unsigned char A)
{
	...
	int k;
	bufferpos += timetable[oldtimetableindex][index]/4; // divide by 4 for pokitto playback
...
//    if (debug) {
    ...
    char text[128];
    sprintf(text, "%d,%d,%d,%d,%d,%d,%d,%d,",sampledConsonantFlag, frequency1, frequency2, frequency3, amplitude1, amplitude2, amplitude3, pitches);
